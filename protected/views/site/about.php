...
<div class="view_wrapper">
    ...
    <div class="block block_1">
        ...
        <div class="block_content">
            ...
            <div class="block_text">
                ...
                couples of time. So i had to register a new account, losing all the stuff, followers, documents,
                achivements, etc
                that was connected with the main account. Due to not instant and not very good support of "Forgot
                password" service,
    ...
    <div class="block block_3">
        ...
        <div class="block_content">
            ...
            <div class="block_text">
                The list of technologies used in the development of Password Keeper is more than impressive. Those contain: Ajax,
                jQuery, MySql DB, Yii PHP framework, CSS3, HTML5, Git
                . Such diversity guarantees top of the line quality and reliability of the portal,
                since every tool is used where it better suits the specific task.
            </div>
        </div>
    </div>
